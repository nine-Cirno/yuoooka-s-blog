...
import TagsPage from './components/pages/Tags.vue';
import ArchivesPage from './components/pages/Archives.vue';
import LinksPage from './components/pages/Links.vue';
import SkillsPage from './components/pages/Skills.vue';
import SeriesPage from './components/pages/Series.vue';
import GuestbookPage from './components/pages/Guestbook.vue';
